...
impl Kucoin {
    pub async fn get_user_subaccount_info(&self) -> Result<APIData<UserInfo>, APIError> {
        ...
        let header = self.sign_headers(endpoint, None, None, Method::GET).unwrap();
        let resp = self.get(url, Some(header)).await?
            .json()
            .await?;
        Ok(resp)
    }
    ...
    -> Result<APIDatum<AccountId>, APIError> {
        ...
        let header = self.sign_headers(endpoint, Some(&params), None, Method::POST).unwrap();
        let resp = self.post(url, Some(header), Some(params)).await?
            .json()
            .await?;
        Ok(resp)
    }

    pub async fn get_accounts_list(&self, 
        currency: Option<&str>, 
    ...
    pub async fn get_account_ledgers(&self, 
        account_id: &str,
        start_at: Option<i64>,
        end_at: Option<i64>,
    ...
    pub async fn get_subaccount_balances(&self, 
        account_id: &str) 
    ...
    pub async fn get_all_subaccount_balances(&self) -> Result<APIData<SubAccountBalances>, APIError> {
    ...
    pub async fn get_transferable_balance(&self,
        currency: &str,
        account_type: AccountType)
    ...
    pub async fn transfer_to_subaccount(&self,
        client_oid: &str,
        currency: &str,
        amount: f32,
        direction: &str,
    ...
    pub async fn inner_transfer(&self,
        client_oid: &str,
        currency: &str,
        from: &str,
        to: &str,
    ...
    pub async fn create_deposit_address(&self, 
        currency: &str, 
        chain: Option<&str>) 
    ...
    pub async fn get_deposit_address(&self,
        currency: &str, 
        chain: Option<&str>) 
    -> Result<APIDatum<DepositAddress>, APIError> {
        let endpoint = String::from("/api/v1/deposit-addresses");
    ...
    pub async fn get_deposit_list(&self,
        currency: Option<&str>,
        start_at: Option<i64>,
        end_at: Option<i64>,
        status: Option<&str>,
    ...
    pub async fn get_v1_deposit_list(&self,
        currency: Option<&str>,
        start_at: Option<i64>,
        end_at: Option<i64>,
        status: Option<&str>,
    ...
    pub async fn get_withdrawals_list(&self,
        currency: Option<&str>,
        start_at: Option<i64>,
        end_at: Option<i64>,
        status: Option<&str>,
    ...
    pub async fn get_v1_withdrawals_list(&self,
        currency: Option<&str>,
        start_at: Option<i64>,
        end_at: Option<i64>,
        status: Option<&str>,
    ...
    pub async fn get_withdrawals_quotas(&self,
        currency: &str,
        chain: Option<&str>)
    ...
    #[allow(clippy::too_many_arguments)]
    pub async fn apply_withdrawal(&self,
        currency: &str,
        address: &str,
        amount: i32,
        memo: Option<&str>,
