...
impl Kucoin {
    ...
    pub async fn post_borrow_order(&self,
        currency: &str,
        trade_type: &str,
        size: f64,
        max_rate: Option<f64>,
    ...
    pub async fn get_borrow_order(&self, order_id: &str) -> Result<APIDatum<BorrowOrder>, APIError> {
    ...
    pub async fn get_repay_record(&self, 
        currency: Option<&str>,
    ...
    pub async fn get_repayment_record(&self, 
        currency: Option<&str>,
        current_page: Option<i32>,
        page_size: Option<i32>)
    ...
    pub async fn one_click_repayment(&self,
        currency: &str,
        sequence: &str,
        size: f64) 
    ...
    pub async fn repay_single_order(&self,
        currency: &str,
        trade_id: &str,
        size: f64) 
    -> Result<APIDatum<String>, APIError> {
    ...
    pub async fn post_lend_order(&self,
        currency: &str,
        size: f32,
        daily_int_rate: f32,
        term: i32) 
    ...
    pub async fn set_auto_lend(&self,
        currency: &str,
        is_enable: bool,
    ...
    pub async fn get_active_order(&self,
        currency: &str,
        current_page: Option<i32>,
        page_size: Option<i32>)
    ...
    pub async fn get_lend_history(&self,
        currency: Option<&str>,
        current_page: Option<i32>,
        page_size: Option<i32>)
    ...
    pub async fn get_active_lend(&self,
        currency: Option<&str>,
        current_page: Option<i32>,
        page_size: Option<i32>)
    ...
    pub async fn get_settled_lend(&self,
        currency: Option<&str>,
        current_page: Option<i32>,
        page_size: Option<i32>)
    ...
    pub async fn get_lend_record(&self, currency: Option<&str>) -> Result<APIData<LendRecord>, APIError> {
    ...
    pub async fn get_lend_market_data(&self, 
        currency: &str,
        term: Option<i32>)
    ...
    pub async fn get_margin_trade_data(&self, currency: &str) -> Result<APIData<MarginTradeData>, APIError> {
